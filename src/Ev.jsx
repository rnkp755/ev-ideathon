          ...
          <div className="flex">
            {[...Array(cells)].map((_, index) => {
              ...
              return (
                <motion.div
                  key={index}
                  className={`h-8 w-full rounded-sm overflow-hidden ${index === 0 ? 'rounded-l-md' : ''
    ...
    >
      ...
      <div className="flex space-x-4 mb-8 z-10">
        ...
        <motion.button
          ...
          className={`${walletAddress ? 'bg-green-500 hover:bg-green-600' : 'bg-purple-500 hover:bg-purple-600'
